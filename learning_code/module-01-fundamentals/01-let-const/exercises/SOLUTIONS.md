# Lời giải tham khảo - let và const
...
- **Xử lý:** Code dùng let và const để khai báo biến đúng cách và phân biệt giá trị có thể gán lại với giá trị không nên gán lại.
